...
<nav class="navbar navbar-default navbar-fixed-top">
  <div class="container-fluid ">
    <div class="navbar-header">
      <a class="navbar-brand text-dark" href="#myPage"><strong>Community Health Tracker</strong></a>
    </div>
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav navbar-right">
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu"> 
       <li> <a href="location map/dhaka.html">Nairobi</a></li>
      <li>  <a href='location map/chittagong.html'>Mombasa</a></li>
       <li> <a href="location map/barishal.html">Meru</a></li>
      <li>  <a href="location map/khulna.html">Karatina</a></li>
     <li>   <a href='location map/mymensingh.html'>Nyeri</a></li>
     <li>   <a href='location map/rajshahi.html'>Kutus</a></li>
     <li>   <a href='location map/rangpur.html'>Embu</a></li>
     <li>   <a href='location map/sylhet.html'>Samburu</a></li>
        </ul>
        </li>
...
<?php
  ...
  <section class="cover">
    <div class="container">
      ...
      <p>A comprehensive system to track and improve community health.</p>
    </div>
  </section>
  ...
  <section id="features" class="features">
    <div class="container">
      <div class="feature">
        <img src="f1.jpeg" alt="Feature 1">
        <h3>Real-Time Data Monitoring</h3>
        <p>Track health data in real-time and identify trends to take proactive measures.</p>
      </div>
      <div class="feature">
        <img src="f2.jpg" alt="Feature 2">
        <h3>Community Engagement</h3>
        <p>Engage with community members through interactive features and forums.</p>
      </div>
      <div class="feature">
        <img src="f3.jpg" alt="Feature 3">
        <h3>Personalized Recommendations</h3>
        <p>Receive personalized health recommendations based on your data and community insights.</p>
      </div>
    </div>
  </section>
  ...
  <section id="about" class="about">
    <div class="container">
      <h2>About Us</h2>
      <p>Our project was inspired by the need for a comprehensive health tracking system that could address the unique challenges faced by our community. As students at Holberton School, we embarked on this journey to create a platform that empowers individuals to take control of their health while fostering community support and collaboration.</p>
      <p>This project is a part of our portfolio for Holberton School. You can find the source code on <a href="https://github.com/yourusername/community-health-tracker">GitHub</a>.</p>
      <div class="team-members">
        ...
        <ul>
          <li><a href="https://linkedin.com/philip ndirangu" target="_blank">LinkedIn</a></li>
          <li><a href="https://github.com/mophs-pioneer" target="_blank">GitHub</a></li>
          <li><a href="https://twitter.com/mophs-pioneer" target="_blank">Twitter</a></li>
        </ul>
      </div>
    </div>
  </section>
...
<footer class="text-center">
  ...
  <p>Copyright<a href="http://labaidgroup.com/specialized/doctor" data-toggle="tooltip" title="e-Healthcare">community Health Tracker</a></p> 
</footer>
<script>
